# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-01-20 13:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='catalog',
            name='identifier',
            field=models.SlugField(blank=True, help_text='The unambiguous internal identifier of this catalog.', max_length=128, null=True, verbose_name='Identifier'),
        ),
        migrations.AddField(
            model_name='catalog',
            name='uri',
            field=models.URLField(blank=True, help_text='The Uniform Resource Identifier of this catalog.', max_length=256, null=True, verbose_name='URI'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='questionentity',
            name='identifier',
            field=models.SlugField(blank=True, help_text='The unambiguous internal identifier of this question/questionset.', max_length=128, null=True, verbose_name='Identifier'),
        ),
        migrations.AddField(
            model_name='questionentity',
            name='uri',
            field=models.URLField(blank=True, help_text='The Uniform Resource Identifier of this question/questionset.', max_length=256, null=True, verbose_name='URI'),
        ),
        migrations.AddField(
            model_name='section',
            name='comment',
        ...
        migrations.AddField(
            model_name='section',
            name='identifier',
            field=models.SlugField(blank=True, help_text='The unambiguous internal identifier of this section.', max_length=128, null=True, verbose_name='Identifier'),
        ),
        migrations.AddField(
            model_name='section',
            name='uri',
            field=models.URLField(blank=True, help_text='The Uniform Resource Identifier of this section.', max_length=256, null=True, verbose_name='URI'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='subsection',
            name='identifier',
            field=models.SlugField(blank=True, help_text='The unambiguous internal identifier of this subsection.', max_length=128, null=True, verbose_name='Identifier'),
        ),
        migrations.AddField(
            model_name='subsection',
            name='uri',
            field=models.URLField(blank=True, help_text='The Uniform Resource Identifier of this subsection.', max_length=256, null=True, verbose_name='URI'),
        ),
