...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'ordering': ('label',), 'verbose_name': 'Attribute entity', 'verbose_name_plural': 'Attribute entities'},
        ),
        migrations.AlterModelOptions(
            name='verbosename',
        ...
        migrations.AlterField(
            model_name='attributeentity',
            name='identifier',
            field=models.SlugField(help_text='Unambiguous internal identifier of this attribute/entity.', max_length=256, verbose_name='Identifier'),
        ),
        migrations.AlterField(
            model_name='attributeentity',
            name='is_attribute',
        ...
        migrations.AlterField(
            model_name='attributeentity',
            name='label',
            field=models.CharField(db_index=True, help_text='Full identifier of this attribute/entity (auto-generated).', max_length=512, verbose_name='Label'),
        ),
        migrations.AlterField(
            model_name='attributeentity',
            name='parent',
        ...
        migrations.AlterField(
            model_name='attributeentity',
            name='uri',
            field=models.URLField(blank=True, help_text='Uniform Resource Identifier of this attribute/entity.', max_length=256, null=True, verbose_name='URI'),
        ),
        migrations.AlterField(
            model_name='range',
            name='attribute',
